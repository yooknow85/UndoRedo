...
namespace DrawTools
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		static void Main(string[] args) 
		{
		    ...
		    UndoRedoManager.Instance().MaxItems = int.MaxValue;
            // Check command line
            if( args.Length > 1 ) 
            {
        ...
        private void Form1_Load(object sender, System.EventArgs e)
        {
            ...
            UndoRedoManager.Instance().UndoStackStatusChanged += new UndoRedoManager.OnStackStatusChanged(Form1_UndoStackStatusChanged);

            UndoRedoManager.Instance().RedoStackStatusChanged += new UndoRedoManager.OnStackStatusChanged(Form1_RedoStackStatusChanged);
        }

        void Form1_RedoStackStatusChanged(bool hasItems)
        {
            menuEditRedo.Enabled = hasItems;
        }

        void Form1_UndoStackStatusChanged(bool hasItems)
        {
            menuEditUndo.Enabled = hasItems;
        }
