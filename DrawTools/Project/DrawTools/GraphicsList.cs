...
namespace DrawTools
{
    ...
    public class GraphicsList : ISerializable
    {
        ...
        public void Add(DrawObject obj)
        {
            ...
            UndoRedoManager.Instance().Push((x) =>{x.Selected = true;  DeleteSelection();}, obj);
        }

        public void SelectInRectangle(Rectangle rectangle)
        {
            UndoRedoManager.Instance().Push((o) => UnselectAll(), this);
            UnselectAll();
        ...
        {
            UndoRedoManager.Instance().Push((o) => SelectAll(), this);
            foreach (DrawObject o in graphicsList)
            {
                o.Selected = false;
            }
        ...
        public bool DeleteSelection()
        {
            ...
            for ( int i = n-1; i >= 0; i-- )
            {
                ...
                {
                    UndoRedoManager.Instance().Push(x => Add(x), ((DrawObject)graphicsList[i]));
